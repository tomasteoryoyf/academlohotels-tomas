	...
	return (
		<header className="header">
			<h1 onClick={closeMenu} className="header__logo">
				<Link to="/">
					Academlo <span className="header__hotel">Hotels</span>
				</Link>
			</h1>
			...
			<nav className={`header__nav ${isOpenMenu || 'nav__close'}`}>
				<ul className="header__list">
					...
					<li onClick={closeMenu} className="header__item" to="/register">
						<Link to="/register">Register</Link>
					</li>
					<li onClick={closeMenu} className="header__item" to="/login">
